...
- **eps = 0.5**: Requires meaningful AIC improvement of at least 0.5 units to continue growing a branch  
- **delta = 2**: Keeps all competitive models within 2 AIC units of the best at each step
- **L = 10**: Limits computational cost by retaining only the 10 best models per step
...
- **Delta = 2**: Retains models within 2 AIC units of the best model, following the standard rule that ΔAIC < 2 indicates substantial support
- **tau = 0.6**: Requires variables to be selected in at least 60% of bootstrap samples, ensuring high selection stability
